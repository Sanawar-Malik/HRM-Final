...
import DeleteProj from './DeleteProj';
import UpdateProject from './UpdateProject';
import AddProject from './AddProject';
import { allProject } from '../services/projectSlice';
            ...
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                {Array.isArray(projects) ? projects.map((project) => {
                  const employee = employees.find((a) => a.id === project.manager);
                  return (
                    <tr key={project.id}>
                      ...
                      <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                        <p className="text-black whitespace-no-wrap">{project.created_at}</p>
                      </td>
                      <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                        <p className="text-black whitespace-no-wrap">{project.end_at}</p>
                      </td>
                      ...
                      <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                        <div className="flex gap-4">
                          ...
                          {UpdateModel && <UpdateProject id={project.id} setUpdateModal={setUpdateModal} />}
                          ...
                          {DeleteModal && <DeleteProj id={id} setDeleteModal={setDeleteModal} />}
