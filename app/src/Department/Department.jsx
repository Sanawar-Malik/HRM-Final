    ...
    <>
      <div className="mx-auto bg-white pb-4 mt-20 shadow-2xl rounded-md w-11/12">
        <div className="flex justify-between w-full p-4  ">
          <h1 className="ml-3 text-2xl font-bold"> Department</h1>
          <div>
            ...
            {showModal && <AddDep setShowModal={setShowModal} />}
          </div>
        </div>
                    ...
                    <tr key={dep.id}>
                      ...
                      <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                        <div className="flex gap-4">
                          <Tooltip title="Edit" onClick={() => [setId(dep.id), setUpdateModal(true)]}>
                            <IconButton >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
                          {UpdateModel && <UpdateDep id={id} setUpdateModal={setUpdateModal} />}

                          <Tooltip title="Delete">
                            <IconButton onClick={() => [setId(dep.id), setDeleteModal(true)]}>
                              <DeleteIcon />
                            </IconButton>
                          </Tooltip>
                          {DeleteModal && <DeleteDep id={id} setDeleteModal={setDeleteModal} />}
